(custom-set-variables
 ...
 '(org-agenda-files (quote ("~/Documents/Tasks/todo.txt" "~/Documents/Tasks/.org-jira/CYE.org" "~/Documents/Tasks/.org-jira/ENVD.org" "~/Documents/Tasks/from-mobile.org")))
...
#+end_ascii") ("A" "#+ascii: ") ("i" "#+index: ?" "#+index: ?") ("I" "#+include %file ?" "<include file=%file markup=\"?\">"))))
 ...
 '(org-tag-alist (quote ((:startgroup) ("@errand" . 101) ("@office" . 111) ("@home" . 72) (:endgroup) ("PHONE" . 112) ("WAITING" . 119) ("HOLD" . 104) ("PERSONAL" . 80) ("WORK" . 87) ("SOCO" . 70) ("ORG" . 79) ("BLOG" . 78) ("crypt" . 69) ("NOTE" . 110) ("KGNU" . 66) ("CANCELLED" . 99) ("FLAGGED" . 63))))
 '(org-tags-exclude-from-inheritance (quote ("crypt")))
 '(org-tags-match-list-sublevels t)
 '(org-time-clocksum-format (quote (:hours "%d" :require-hours t :minutes ":%02d" :require-minutes t)))
 '(org-todo-keyword-faces (quote (("TODO" :foreground "cyan" :weight bold) ("NEXT" :foreground "yellow" :weight bold) ("DONE" :foreground "base02" :weight bold) ("WAITING" :foreground "orange" :weight bold) ("HOLD" :foreground "magenta" :weight bold) ("CANCELLED" :foreground "base00" :weight bold) ("MEETING" :foreground "green" :weight bold) ("PHONE" :foreground "red" :weight bold))))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(org-agenda-dimmed-todo-face ((t (:foreground "#586e75"))))
 '(org-agenda-done ((t (:foreground "#657b83"))))
 '(org-agenda-restriction-lock ((t (:background "#002b36"))))
 '(org-agenda-structure ((t (:foreground "#859900"))))
 '(org-clock-overlay ((t (:background "#268bd2"))))
 '(org-column ((t (:background "#93a1a1" :strike-through nil :underline nil :slant normal :weight normal :height 120 :family "Monaco"))))
 '(org-column-title ((t (:background "#839496" :underline t :weight bold))))
 '(org-date ((t (:foreground "#d33682" :underline t))))
 '(org-date-selected ((t (:foreground "#6c71c4" :inverse-video t))))
 '(org-document-info ((t (:foreground "#2aa198"))))
 '(org-document-title ((t (:foreground "#268bd2" :weight bold))))
 '(org-drawer ((t (:foreground "#268bd2"))))
 '(org-ellipsis ((t (:foreground "#b58900" :underline t))))
 '(org-footnote ((t (:foreground "#657b83" :underline t))))
 '(org-formula ((t (:foreground "#93a1a1"))))
 '(org-habit-alert-face ((t (:background "#b58900"))))
 '(org-habit-alert-future-face ((t (:background "#cb4b16"))))
 '(org-habit-clear-face ((t (:background "#2aa198"))))
 '(org-habit-clear-future-face ((t (:background "#268bd2"))))
 '(org-habit-overdue-face ((t (:background "#6c71c4"))))
 '(org-habit-overdue-future-face ((t (:background "#d33682"))))
 '(org-habit-ready-face ((t (:background "#2aa198"))))
 '(org-habit-ready-future-face ((t (:background "#859900"))))
 '(org-headline-done ((t (:foreground "#586e75"))))
 '(org-latex-and-related ((t (:foreground "#b58900"))))
 '(org-mode-line-clock ((t (:foreground "#dc322f" :box (:line-width -1 :style released-button)))) t)
 '(org-scheduled ((t (:foreground "#586e75"))))
 '(org-scheduled-previously ((t (:foreground "#657b83"))))
 '(org-scheduled-today ((t (:foreground "#93a1a1"))))
 '(org-sexp-date ((t (:foreground "#2aa198"))))
 '(org-table ((t (:foreground "#839496"))))
 '(org-time-grid ((t (:foreground "#b58900"))))
 '(org-todo ((t (:background "#dc322f" :foreground "#2aa198" :inverse-video nil :underline nil :slant normal :weight bold))))
 '(org-upcoming-deadline ((t (:foreground "#93a1a1")))))
