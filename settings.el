...
(custom-set-faces
 ...
 '(emms-metaplaylist-mode-current-face ((t (:foreground "#dc322f"))))
 '(emms-metaplaylist-mode-face ((t (:foreground "#93a1a1"))))
 '(emms-playlist-selected-face ((t (:foreground "#268bd2"))))
 '(emms-playlist-track-face ((t (:foreground "#859900"))))
 '(emms-stream-url-face ((t (:foreground "#268bd2"))))
 ...
 '(w3m-arrived-anchor ((t (:foreground "#d33682"))))
 '(w3m-form ((t (:underline t))))
 '(w3m-form-button ((t (:background "#002b36" :foreground "#268bd2" :box (:line-width 2 :style released-button)))))
 '(w3m-form-button-mouse ((t (:background "#073642" :foreground "#b58900" :box (:line-width 2 :style released-button)))))
 '(w3m-form-button-pressed ((t (:background "#d33682" :foreground "#fdf6e3" :box (:line-width 2 :style pressed-button)))))
 '(w3m-form-inactive ((t nil)))
 '(w3m-header-line-location-content ((t (:background "#073642" :foreground "#b58900"))))
 '(w3m-header-line-location-title ((t (:background "#002b36" :foreground "#586e75"))))
 '(w3m-history-current-url ((t (:background "#073642" :foreground "#268bd2"))))
 '(w3m-image ((t (:foreground "#6c71c4q"))))
 '(w3m-image-anchor ((t (:background "#073642"))))
 '(w3m-insert ((t (:foreground "#b58900"))))
 '(w3m-linknum-match ((t (:background "#d33682"))) t)
 '(w3m-linknum-minibuffer-prompt ((t (:foreground "#2aa198"))) t)
 '(w3m-session-select ((t (:foreground "#93a1a1"))))
 '(w3m-session-selected ((t (:foreground "#93a1a1" :underline t :weight bold))))
 '(w3m-tab-background ((t (:background "#eee8d5" :foreground "#839496"))))
 '(w3m-tab-mouse ((t (:background "#eee8d5" :foreground "#93a1a1" :box (:line-width -1 :style released-button)))))
 '(w3m-tab-selected ((t (:background "#fdf6e3" :foreground "#586e75" :box (:line-width -1 :style released-button)))))
 '(w3m-tab-selected-background ((t (:background "#eee8d5" :foreground "#839496"))))
 '(w3m-tab-selected-retrieving ((t (:background "#fdf6e3" :foreground "#dc322f" :box (:line-width -1 :style released-button)))))
