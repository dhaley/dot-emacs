...
(custom-set-faces
 ...
 '(w3m-anchor ((t (:foreground "#2aa198"))))
 '(w3m-arrived-anchor ((t (:foreground "#268bd2"))))
 '(w3m-form ((t (:underline t))))
 '(w3m-form-button ((t (:background "#fdf6e3" :foreground "#586e75" :box (:line-width 2 :style released-button)))))
 '(w3m-form-button-mouse ((t (:background "#eee8d5" :foreground "#657b83" :box (:line-width 2 :style released-button)))))
 '(w3m-form-button-pressed ((t (:background "#839496" :foreground "#fdf6e3" :box (:line-width 2 :style pressed-button)))))
 '(w3m-form-inactive ((t nil)))
 '(w3m-header-line-location-content ((t (:background "#fdf6e3" :foreground "#586e75"))))
 '(w3m-header-line-location-title ((t (:background "#eee8d5" :foreground "#586e75"))))
 '(w3m-history-current-url ((t (:background "#073642" :foreground "#268bd2"))))
 '(w3m-image ((t (:foreground "#6c71c4"))))
 '(w3m-image-anchor ((t (:background "#fdf6e3"))))
