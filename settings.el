(custom-set-variables
 ...
 '(exec-path (quote ("/Applications/MAMP/bin/php/php5.3.13/bin" "/Users/daha1836/bin" "/usr/local/bin" "/usr/local/sbin" "/usr/local/opt/git/share/git-core" "/usr/bin" "/bin" "/usr/local/sbin" "/usr/sbin" "/sbin" "/usr/X11R6/bin" "~/.cabal/bin/")))
 '(fill-column 78)
...
(custom-set-faces
 ...
 '(w3m-form-button-pressed ((t (:background "#fdf6e3" :foreground "#839496" :box (:line-width 2 :style pressed-button)))) t)
 ...
 '(w3m-image-anchor ((t (:background "#859900"))) t)
