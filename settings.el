(custom-set-variables
 ...
 '(erc-modules (quote (autojoin button completion dcc fill identd irccontrols list match menu move-to-prompt netsplit networks noncommands readonly replace ring scrolltobottom services smiley stamp spelling track truncate highlight-nicknames youtube)))
 '(erc-nick "dkh")
...
(custom-set-faces
 ...
 '(bg:erc-color-face0 ((t (:background "#fdf6e3"))))
 '(bg:erc-color-face1 ((t (:background "#eee8d5"))))
 '(bg:erc-color-face11 ((t (:background "#2aa198"))))
 '(bg:erc-color-face12 ((t (:background "#268bd2"))))
 '(bg:erc-color-face2 ((t (:background "#586e75"))))
 '(bg:erc-color-face3 ((t (:background "#859900"))))
 '(bg:erc-color-face4 ((t (:background "#dc322f"))))
 '(bg:erc-color-face6 ((t (:background "#6c71c4"))))
 '(bg:erc-color-face7 ((t (:background "#cb4b16"))))
 '(bg:erc-color-face8 ((t (:background "#b58900"))))
 '(bg:erc-color-face9 ((t (:background "#859900"))))
 ...
 '(diff-added ((((background dark)) (:foreground "#93a1a1")) (t (:foreground "#859900"))) t)
 '(diff-added2 ((t (:foreground "#2aa198"))) t)
 '(diff-changed ((((background dark)) (:foreground "#B58900")) (t (:foreground "#268bd2"))) t)
 '(diff-context ((((background dark)) (:foreground "#93a1a1")) (t (:foreground "#586e75"))))
 '(diff-file-header ((((background dark)) (:foreground "#2aa198" :background "#073642")) (t (:foreground "#93a1a1" :background "#fdf6e3"))) t)
 '(diff-header ((((background dark)) (:foreground "#268bd2")) (t (:foreground "#dc322f"))) t)
 ...
 '(diff-removed ((t (:foreground "#dc322f"))) t)
 ...
 '(erc-dangerous-host-face ((t (:foreground "#dc322f"))))
 '(erc-direct-msg-face ((t (:foreground "#d33682"))))
 ...
 '(fg:erc-color-face0 ((t (:foreground "#dc322f"))))
 '(fg:erc-color-face1 ((t (:foreground "#d33682"))))
 '(fg:erc-color-face10 ((t (:foreground "#6c71c4"))))
 '(fg:erc-color-face11 ((t (:foreground "#268bd2"))))
 '(fg:erc-color-face12 ((t (:foreground "#2aa198"))))
 '(fg:erc-color-face13 ((t (:foreground "#859900"))))
 '(fg:erc-color-face14 ((t (:foreground "#839496"))))
 '(fg:erc-color-face15 ((t (:foreground "#93a1a1"))))
 '(fg:erc-color-face2 ((t (:foreground "#b58900"))))
 '(fg:erc-color-face3 ((t (:foreground "#cb4b16"))))
 '(fg:erc-color-face4 ((t (:foreground "#dc322f"))))
 '(fg:erc-color-face5 ((t (:foreground "#d33682"))))
 '(fg:erc-color-face6 ((t (:foreground "#6c71c4"))))
 '(fg:erc-color-face7 ((t (:foreground "#268bd2"))))
 '(fg:erc-color-face8 ((t (:foreground "#2aa198"))))
 '(fg:erc-color-face9 ((t (:foreground "#859900"))))
 ...
 '(jiralib-comment-face ((t (:background "#93a1a1"))) t)
 '(jiralib-issue-info-face ((t (:background "#fdf6e3" :foreground "#268bd2"))) t)
