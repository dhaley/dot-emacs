...
(custom-set-faces
 ...
 '(cfw:face-annotation ((t (:inherit cfw:face-day-title :foreground "#839496"))))
 '(cfw:face-day-title ((t (:background "#eee8d5"))))
 '(cfw:face-default-content ((t (:foreground "#93a1a1"))))
 '(cfw:face-disable ((t (:inherit cfw:face-day-title :foreground "#586e75"))))
 '(cfw:face-grid ((t (:foreground "#859900"))))
 '(cfw:face-header ((t (:foreground "#6c71c4" :weight bold))))
 '(cfw:face-holiday ((t (:background "#fdf6e3" :foreground "#d33682" :weight bold))))
 '(cfw:face-periods ((t (:foreground "#2aa198"))))
 '(cfw:face-saturday ((((class color) (background light)) (:background "#eee8d5" :foreground "#268bd2" :weight bold)) (((class color) (background light)) (:foreground "#268bd2" :weight bold))))
 '(cfw:face-select ((t (:background "#268bd2"))))
 '(cfw:face-sunday ((t (:foreground "#dc322f" :weight bold))))
 '(cfw:face-title ((t (:inherit variable-pitch :foreground "#b58900" :weight bold :height 2.0))))
 '(cfw:face-today ((t (:foreground "#2aa198" :weight bold))))
 '(cfw:face-today-title ((t (:background "#cb4b16" :weight bold))))
 '(cfw:face-toolbar ((t (:background "#073642" :foreground "#93a1a1"))))
 '(cfw:face-toolbar-button-off ((t (:foreground "#586e75" :weight bold))))
 '(cfw:face-toolbar-button-on ((t (:foreground "#657b83" :weight bold))))
 ...
 '(w3m-linknum-match ((t (:background "#d33682"))))
 '(w3m-linknum-minibuffer-prompt ((t (:foreground "#2aa198"))))
