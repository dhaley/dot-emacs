(custom-set-variables
 ...
 '(ansi-color-names-vector ["#2aa198" "#dc322f" "#859900" "#6c71c4" "#268bd2" "#d33682" "#cb4b16" "#b58900"])
 '(auth-sources (quote ((:source "~/Messages/.authinfo.gpg" :host t :protocol t))))
 ...
 '(erc-nick "dkh")
 '(erc-pals (quote ("laimagaigalas" "matu4921" "^johnw!" "sachac" "matt" "kevin" "jo" "cathy" "wiegley" "qdot" "crafts" "miles" "alfredo" "Karin" "BerntH" "technomancy" "ultimateboy" "a00001" "bozhidar" "magnars" "erin")))
 '(erc-port 6667)
 ...
 '(ispell-personal-dictionary "~/Messages/.aspell.en.pws")
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(ac-completion-face ((t (:foreground "#586e75" :underline t))))
 '(ac-gtags-candidate-face ((t (:inherit ac-candidate-face :foreground "#268bd2"))))
 '(ac-gtags-selection-face ((t (:inherit ac-selection-face :background "#6c71c4"))))
 '(ac-yasnippet-candidate-face ((t (:inherit ac-candidate-face :background "#fdf6e3" :foreground "#586e75"))))
 '(ac-yasnippet-selection-face ((t (:inherit ac-selection-face :background "#dc322f"))))
 '(bg:erc-color-face0 ((t (:background "#fdf6e3"))) t)
 '(bg:erc-color-face1 ((t (:background "#eee8d5"))) t)
 '(bg:erc-color-face11 ((t (:background "#2aa198"))) t)
 '(bg:erc-color-face12 ((t (:background "#268bd2"))) t)
 '(bg:erc-color-face2 ((t (:background "#586e75"))) t)
 '(bg:erc-color-face3 ((t (:background "#859900"))) t)
 '(bg:erc-color-face4 ((t (:background "#dc322f"))) t)
 '(bg:erc-color-face6 ((t (:background "#6c71c4"))) t)
 '(bg:erc-color-face7 ((t (:background "#cb4b16"))) t)
 '(bg:erc-color-face8 ((t (:background "#b58900"))) t)
 '(bg:erc-color-face9 ((t (:background "#859900"))) t)
 '(cfw:face-annotation ((t (:inherit cfw:face-day-title :foreground "#839496"))) t)
 '(cfw:face-day-title ((t (:background "#eee8d5"))) t)
 '(cfw:face-default-content ((t (:foreground "#93a1a1"))) t)
 '(cfw:face-disable ((t (:inherit cfw:face-day-title :foreground "#586e75"))) t)
 '(cfw:face-grid ((t (:foreground "#859900"))) t)
 '(cfw:face-header ((t (:foreground "#6c71c4" :weight bold))) t)
 '(cfw:face-holiday ((t (:background "#fdf6e3" :foreground "#d33682" :weight bold))) t)
 '(cfw:face-periods ((t (:foreground "#2aa198"))) t)
 '(cfw:face-saturday ((((class color) (background light)) (:background "#eee8d5" :foreground "#268bd2" :weight bold)) (((class color) (background light)) (:foreground "#268bd2" :weight bold))) t)
 '(cfw:face-select ((t (:background "#268bd2"))) t)
 '(cfw:face-sunday ((t (:foreground "#dc322f" :weight bold))) t)
 '(cfw:face-title ((t (:inherit variable-pitch :foreground "#b58900" :weight bold :height 2.0))) t)
 '(cfw:face-today ((t (:foreground "#2aa198" :weight bold))) t)
 '(cfw:face-today-title ((t (:background "#cb4b16" :weight bold))) t)
 '(cfw:face-toolbar ((t (:background "#073642" :foreground "#93a1a1"))) t)
 '(cfw:face-toolbar-button-off ((t (:foreground "#586e75" :weight bold))) t)
 '(cfw:face-toolbar-button-on ((t (:foreground "#657b83" :weight bold))) t)
 '(completions-common-part ((t (:inherit default :foreground "#dc322f"))))
 '(diary ((t (:foreground "#b58900"))))
 '(diary-button ((((type pc) (class color)) (:foreground "#268bd2"))))
 ...
 '(diff-context ((((background dark)) (:foreground "#93a1a1")) (t (:foreground "#586e75"))))
 '(diff-file-header ((((background dark)) (:foreground "#2aa198" :background "#073642")) (t (:foreground "#93a1a1" :background "#fdf6e3"))))
 '(diff-header ((((background dark)) (:foreground "#268bd2")) (t (:foreground "#dc322f"))))
 '(diff-hunk-header ((t (:background "#eee8d5" :foreground "#586e75"))))
 '(diff-index ((((background dark)) (:foreground "#d33682")) (t (:foreground "#859900"))))
 '(diff-nonexistent ((((background dark)) (:foreground "#93a1a1")) (t (:foreground "#268bd2"))))
 '(diff-refine-change ((t (:inherit diff-refine-change :background nil))))
 '(diff-removed ((t (:foreground "#dc322f"))))
 '(diff-removed2 ((t (:foreground "#Cb4b16"))) t)
 ...
 '(emms-playlist-selected-face ((t (:foreground "#268bd2"))) t)
 '(emms-playlist-track-face ((t (:foreground "#859900"))) t)
 ...
 '(erc-current-nick-face ((t (:foreground "#b58900" :weight bold))) t)
 '(erc-dangerous-host-face ((t (:foreground "#dc322f"))) t)
 '(erc-direct-msg-face ((t (:foreground "#d33682"))) t)
 '(erc-error-face ((t (:foreground "#dc322f"))) t)
 '(erc-header-line ((t (:background "#fdf6e3" :foreground "#586e75"))) t)
 '(erc-inverse-face ((t (:background "#fdf6e3" :foreground "#586e75"))) t)
 '(erc-my-nick-face ((t (:foreground "#586e75" :weight bold))) t)
 '(erc-nick-msg-face ((t (:foreground "#268bd2" :weight bold))) t)
 '(erc-pal-face ((t (:foreground "#d33682" :weight bold))) t)
 '(erc-prompt-face ((t (:background "#002b36" :foreground "#b58900" :weight bold))) t)
 '(erc-timestamp-face ((t (:foreground "#586e75"))) t)
 '(fg:erc-color-face0 ((t (:foreground "#93a1a1"))) t)
 '(fg:erc-color-face1 ((t (:foreground "#586e75"))) t)
 '(fg:erc-color-face11 ((t (:foreground "#2aa198"))) t)
 '(fg:erc-color-face12 ((t (:foreground "#268bd2"))) t)
 '(fg:erc-color-face2 ((t (:foreground "#586e75"))) t)
 '(fg:erc-color-face3 ((t (:foreground "#8599004"))) t)
 '(fg:erc-color-face4 ((t (:foreground "#dc322f"))) t)
 '(fg:erc-color-face6 ((t (:foreground "#6c71c4"))) t)
 '(fg:erc-color-face7 ((t (:foreground "#cb4b16"))) t)
 '(fg:erc-color-face8 ((t (:foreground "#b58900"))) t)
 '(fg:erc-color-face9 ((t (:foreground "#859900"))) t)
 '(fic-author-face ((t (:background "#fdf6e3" :foreground "#cb4b16" :underline t))))
 '(fic-face ((t (:background "#eee8d5" :foreground "#dc322f" :weight bold))))
 '(flycheck-error ((t (:underline (:color "red1" :style wave)))))
 '(flycheck-warning ((t (:underline (:color "DeepSkyBlue" :style wave)))))
 '(flyparse-error-face ((t (:background "LightPink"))) t)
 '(flyparse-warning-face ((t (:background "DeepSkyBlue"))) t)
 '(font-lock-comment-face ((t (:foreground "#586e75" :inverse-video nil :underline nil :slant italic :weight normal))))
 '(helm-M-x-key ((t (:foreground "#dc322f" :underline t))) t)
 '(helm-candidate-number ((t (:background "#faffb5" :foreground "#586e75"))))
 ...
 '(info-menu-star ((t (:foreground "#b58900"))))
 '(info-node ((t (:foreground "#d33682" :slant italic :weight bold))))
 '(jiralib-comment-face ((t (:background "#93a1a1"))))
 '(jiralib-issue-info-face ((t (:background "#fdf6e3" :foreground "#268bd2"))))
 '(ledger-register-pending-face ((t (:weight bold))) t)
 '(lusty-match-face ((t (:inherit helm-match))) t)
 '(magit-branch-face ((((class color) (background light)) (:foreground "#268bd2"))) t)
 '(magit-diff-add ((t (:inherit diff-added :weight normal))))
 '(magit-diff-del ((t (:inherit diff-removed :weight normal))))
 '(magit-diff-none-face ((((class color) (background light)) (:foreground "#657b83"))) t)
 '(magit-header ((t (:weight bold))))
 '(magit-topgit-current ((t nil)))
 '(match ((t (:inherit lazy-highlight :reverse t))))
 '(rainbow-delimiters-depth-1-face ((t (:foreground "#268bd2"))) t)
 '(rainbow-delimiters-depth-2-face ((t (:foreground "#6c71c4"))) t)
 ...
 '(rainbow-delimiters-unmatched-face ((t (:foreground "#dc322f"))) t)
 '(show-paren-match ((((class color) (background light)) (:background "azure2"))) t)
 '(term-color-black ((t (:background "#073642" :foreground "#586e75"))) t)
 '(term-color-blue ((t (:background "#073642" :foreground "#268bd2"))) t)
 '(term-color-cyan ((t (:background "#073642" :foreground "#2aa198"))) t)
 '(term-color-green ((t (:background "#073642" :foreground "#859900"))) t)
 '(term-color-magenta ((t (:background "#073642" :foreground "#d33682"))) t)
 '(term-color-red ((t (:background "#073642" :foreground "#dc322f"))) t)
 '(term-color-white ((t (:background "#073642" :foreground "#93a1a1"))) t)
 '(term-color-yellow ((t (:background "#073642" :foreground "#b58900"))) t)
 '(trailing-whitespace ((((class color) (background light)) (:background "#268bd2"))))
 '(w3m-anchor ((t (:foreground "#268bd2"))) t)
 '(w3m-arrived-anchor ((t (:foreground "#d33682"))) t)
 '(w3m-form ((t (:underline t))) t)
 '(w3m-form-button ((t (:background "#002b36" :foreground "#268bd2" :box (:line-width 2 :style released-button)))) t)
 '(w3m-form-button-mouse ((t (:background "#073642" :foreground "#b58900" :box (:line-width 2 :style released-button)))) t)
 '(w3m-form-button-pressed ((t (:background "#d33682" :foreground "#fdf6e3" :box (:line-width 2 :style pressed-button)))) t)
 '(w3m-form-inactive ((t nil)) t)
 '(w3m-header-line-location-content ((t (:background "#073642" :foreground "#b58900"))) t)
 '(w3m-header-line-location-title ((t (:background "#002b36" :foreground "#586e75"))) t)
 '(w3m-history-current-url ((t (:background "#073642" :foreground "#268bd2"))) t)
 '(w3m-image ((t (:foreground "#6c71c4q"))) t)
 '(w3m-image-anchor ((t (:background "#073642"))) t)
 '(w3m-insert ((t (:foreground "#b58900"))) t)
 '(w3m-linknum-match ((t (:background "#d33682"))) t)
 '(w3m-linknum-minibuffer-prompt ((t (:foreground "#2aa198"))) t)
 '(w3m-session-select ((t (:foreground "#93a1a1"))) t)
 '(w3m-session-selected ((t (:foreground "#93a1a1" :underline t :weight bold))) t)
 '(w3m-tab-background ((t (:background "#eee8d5" :foreground "#839496"))) t)
 '(w3m-tab-mouse ((t (:background "#eee8d5" :foreground "#93a1a1" :box (:line-width -1 :style released-button)))) t)
 '(w3m-tab-selected ((t (:background "#fdf6e3" :foreground "#586e75" :box (:line-width -1 :style released-button)))) t)
 '(w3m-tab-selected-background ((t (:background "#eee8d5" :foreground "#839496"))) t)
 '(w3m-tab-selected-retrieving ((t (:background "#fdf6e3" :foreground "#dc322f" :box (:line-width -1 :style released-button)))) t)
 '(w3m-tab-unselected ((t (:background "#073642" :foreground "#586e75" :box (:line-width -1 :style released-button)))) t)
 '(w3m-tab-unselected-retrieving ((t (:background "#eee8d5" :foreground "#cb4b16" :box (:line-width -1 :style released-button)))) t)
 '(w3m-tab-unselected-unseen ((t (:background "#fdf6e3" :foreground "#586e75" :box (:line-width -1 :style released-button)))) t)
 '(wg-brace-face ((((class color)) (:foreground "#6c71c4"))))
 '(wg-command-face ((((class color)) (:foreground "#2aa198"))))
 '(wg-current-workgroup-face ((t (:foreground "#268bd2"))))
 '(wg-divider-face ((((class color)) (:foreground "#2aa198"))))
 ...
 '(wg-previous-workgroup-face ((t (:foreground "#93a1a1"))))
 '(which-func ((t (:foreground "#268bd2"))) t)
 '(whitespace-line ((t (:background "#073642" :foreground "#6c71c4")))))
