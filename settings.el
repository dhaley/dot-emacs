(custom-set-variables
 ...
 '(custom-safe-themes (quote ("1e7e097ec8cb1f8c3a912d7e1e0331caeed49fef6cff220be63bd2a6ba4cc365" "d677ef584c6dfc0697901a44b885cc18e206f05114c8a3b7fde674fce6180879" "71b172ea4aad108801421cc5251edb6c792f3adbaecfa1c52e94e3d99634dee7" "fc5fcb6f1f1c1bc01305694c59a1a861b008c534cae8d0e48e4d5e81ad718bc6" "8aebf25556399b58091e533e455dd50a6a9cba958cc4ebb0aab175863c25b9a4" default)))
 ...
 '(erc-autojoin-channels-alist (quote ((".*\\.freenode.net" "#drupal-colorado" "#emacs" "#fsf-members" "#erc" "#org-mode" "#freedombox"))))
 '(erc-autojoin-mode t)
 ...
 '(history-length 200)
 '(hl-line-face (quote hl-spotlight))
 ...
 '(ibuffer-saved-filter-groups (quote (("default" ("emacs Lisp" (mode . emacs-lisp-mode)) ("python" (mode . python-mode)) ("ruby" (mode . ruby-mode)) ("coffee-script" (mode . coffee-mode)) ("java-script" (or (mode . js-mode) (mode . js2-mode))) ("Web Dev" (or (mode . html-mode) (mode . web-mode) (mode . haml-mode) (mode . css-mode))) ("xml" (mode . nxml-mode)) ("org agenda" (mode . org-agenda-mode)) ("org" (or (mode . org-mode) (name . "^\\*Calendar\\*$") (name . "^diary$"))) ("text misc" (or (mode . text-mode) (mode . rst-mode) (mode . markdown-mode))) ("w3m" (mode . w3m-mode)) ("Magit" (or (mode . magit-log-edit-mode) (mode . magit-log))) ("dired" (mode . dired-mode)) ("help" (or (mode . Info-mode) (mode . help-mode) (mode . Man-mode) (mode . apropos-mode) (mode . woman-mode) (name . "*Help*") (name . "*Apropos*") (name . "*info*"))) ("*helm*" (name . "^\\*helm.*\\*")) ("*buffer*" (name . "\\*.*\\*")) ("ssh" (or (name . "\\*tramp") (name . "^\\*debug tramp"))) ("emacs" (or (mode . occur-mode) (mode . bookmark-bmenu-mode) (name . "^\\*scratch\\*$") (name . "^\\*Messages\\*$") (name . "^\\*Compile-Log\\*$") (name . "^\\*Backtrace\\*$") (name . "^\\*info\\*$") (name . "^\\*Occur\\*$") (name . "^\\*grep\\*$") (name . "^\\*Process List\\*$") (name . "^\\*gud\\*$") (name . "^\\*compilation\\*$") (name . "^\\*Kill Ring\\*$"))) ("latex" (or (mode . latex-mode) (mode . LaTeX-mode) (mode . bibtex-mode) (mode . reftex-mode))) ("irc" (or (name . "^\\*Sauron\\*$") (mode . garak-mode) (name . "^\\*Garak\\*$") (mode . erc-mode) (mode . twittering-mode) (name . "^\\*scratch\\* (irc)$"))) ("gnus" (or (mode . message-mode) (mode . bbdb-mode) (mode . mail-mode) (mode . gnus-group-mode) (mode . gnus-summary-mode) (mode . gnus-article-mode) (name . "^\\.bbdb$") (name . "^\\*fetchmail\\*$") (name . "^\\.newsrc-dribble") (name . "^\\*gnus trace\\*$") (name . "^\\*scratch\\* (gnus)$"))) ("Magit" (name . "*magit"))))))
...
")
 ...
 '(tls-program (quote ("openssl s_client -connect %h:%p -no_ssl2 -ign_eof -CApath /etc/postfix/certs")))
