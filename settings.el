...
(custom-set-faces
 ...
 '(helm-M-x-key ((t (:foreground "#dc322f" :underline t))))
 ...
 '(w3m-form-button-pressed ((t (:background "#fdf6e3" :foreground "#839496" :box (:line-width 2 :style pressed-button)))))
 ...
 '(w3m-image-anchor ((t (:background "#859900"))))
