(custom-set-variables
 ...
 '(pp^L-^L-string "                                                                              ")
 '(projectile-globally-ignored-directories (quote (".idea" ".eunit" ".git" ".hg" ".fslckout" ".bzr" "_darcs" "sites/default/files" "modules" "themes" ".shelly" "FirePHPCore" "sites/all" "libraries")))
 '(projectile-globally-ignored-files (quote ("TAGS" ".gitignore" ".gitmodules" ".htaccess" "authorize.php" "cron.php" "install.php" "robots.txt" "update.php" "xmlrpc.php" "web.config")))
...
(custom-set-faces
 ...
 '(erc-direct-msg-face ((t (:foreground "IndianRed"))) t)
 ...
 '(erc-prompt-face ((t (:background "#eee8d5" :foreground "#586e75" :weight bold))) t)
 '(erc-timestamp-face ((t (:foreground "#6c71c4"))) t)
 ...
 '(term-color-black ((t (:background "#073642" :foreground "#586e75"))))
 '(term-color-blue ((t (:background "#073642" :foreground "#268bd2"))))
 '(term-color-cyan ((t (:background "#073642" :foreground "#2aa198"))))
 '(term-color-green ((t (:background "#073642" :foreground "#859900"))))
 '(term-color-magenta ((t (:background "#073642" :foreground "#d33682"))))
 '(term-color-red ((t (:background "#073642" :foreground "#dc322f"))))
 '(term-color-white ((t (:background "#073642" :foreground "#93a1a1"))))
 '(term-color-yellow ((t (:background "#073642" :foreground "#b58900"))))
 '(trailing-whitespace ((((class color) (background light)) (:background "#268bd2"))))
 '(w3m-anchor ((t (:foreground "#2aa198"))) t)
 '(w3m-arrived-anchor ((t (:foreground "#268bd2"))) t)
 '(w3m-form ((t (:underline t))) t)
 '(w3m-form-button ((t (:background "#fdf6e3" :foreground "#586e75" :box (:line-width 2 :style released-button)))) t)
 '(w3m-form-button-mouse ((t (:background "#eee8d5" :foreground "#657b83" :box (:line-width 2 :style released-button)))) t)
 '(w3m-form-button-pressed ((t (:background "#839496" :foreground "#fdf6e3" :box (:line-width 2 :style pressed-button)))) t)
 '(w3m-form-inactive ((t nil)) t)
 '(w3m-header-line-location-content ((t (:background "#fdf6e3" :foreground "#586e75"))) t)
 '(w3m-header-line-location-title ((t (:background "#eee8d5" :foreground "#586e75"))) t)
 '(w3m-history-current-url ((t (:background "#073642" :foreground "#268bd2"))) t)
 '(w3m-image ((t (:foreground "#6c71c4"))) t)
 '(w3m-image-anchor ((t (:background "#fdf6e3"))) t)
