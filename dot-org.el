...
(add-to-list 'org-agenda-custom-commands
 ...
 ((org-agenda-ndays 7)                          ;; [1]
          ...
          (org-agenda-repeating-timestamp-show-all t)   ;; [3]
               ...
               ((org-agenda-with-colors nil)
(org-agenda-remove-tags t)
;;(org-agenda-sorting-strategy '(category-up)) ;; (5) cont.
)
 ("~/git/dkh-org/agendas/agenda_weekly.pdf")
))
...
(local-set-key [(control c) (\")] 'double-quote)
...
(setq org2blog/wp-blog-alist
  ...
  (setq org-publish-project-alist
        ...
        ; norang is the top-level project that gets published
        (quote (("vcr-org"
                 :base-directory "~/git/cu"
                 :publishing-directory "/ssh:daha1836@pup.colorado.edu:/data/web/htdocs/dashboard/vcr"
                 :exclude "^sql\\|^views\\|^doc\\|org-templates\\|exports\\|cu_ldap\\|old_projects\\|oit_agile\\|igp_success\\|legacy\\|rcr"
                 :recursive t
                 :table-of-contents nil
                 :base-extension "org"
                 :publishing-function org-publish-org-to-html
                 ...
                 :section-numbers nil
                 :table-of-contents nil
                 :style "<link rel=\"stylesheet\" href=\"./css/zenburn-code.css\" type=\"text/css\" />"
                 :author-info nil
                 :creator-info nil)
                ("vcr-extra"
                 :base-directory "~/git/cu"
                 :publishing-directory "/ssh:daha1836@pup.colorado.edu:/data/web/htdocs/dashboard/vcr"
                 :exclude "^sql\\|^views\\|^doc\\|org-templates\\|exports\\|cu_ldap\\|old_projects\\|oit_agile\\|igp_success\\|legacy"
                 :base-extension "css\\|pdf\\|png\\|jpg\\|gif|js"
                 :publishing-function org-publish-attachment
                 :recursive t
                 :author nil)
                ("vcr"
                 :components ("vcr-org" "vcr-extra"))
("vinylisland-org"
               :base-directory "~/git/blog"
                 :publishing-directory "/ssh:vinylisl@vinylisland.org:/home/vinylisl/vinylisland.org"
                 :recursive t
                 :table-of-contents nil
                 :base-extension "org"
                 :publishing-function org-publish-org-to-html
...
("vinylisland-extra"
    :base-directory "~/git/blog"
    :publishing-directory "/ssh:vinylisl@vinylisland.org:/home/vinylisl/vinylisland.org"
    :base-extension "css\\|pdf\\|png\\|jpg\\|gif|js\\|txt"
    :publishing-function org-publish-attachment
    :recursive t
    :author nil)
("vinylisland"
 :components ("vinylisland-org" "vinylisland-extra"))
("netlsd-org"
               :base-directory "~/git/netlsd"
                 :publishing-directory "/ssh:vinylisl@vinylisl.netlsd.com:~/html"
                 :recursive t
                 :table-of-contents nil
                 :base-extension "org"
                 :publishing-function org-publish-org-to-html
...
("netlsd-extra"
    ...
    :author nil)
("netlsd"
 :components ("netlsd-org" "netlsd-extra"))
                  ("cu-html"                                                                                                                                                  
                       :base-directory "~/git/cu/"                                                                                                                                
                       :base-extension "org"                                                                                                                                   
                       :publishing-directory "~/git/cu/exports"                                                                                                                   
                       :publishing-function org-publish-org-to-html)                                                                                                           
                      ("cu-pdf"
                       :base-directory "~/git/cu/"
                       :base-extension "org"
                      ...
                      ("cu-hardcopy" :components ("cu-html" "cu-pdf"))
                   ("dkh-professional-plan"
                       :base-directory "~/git/dkh-org/professional_plan/"
                       :base-extension "org"
                       :publishing-directory "~/git/dkh-org/professional_plan/exports"
                       :publishing-function org-publish-org-to-pdf
                       :include ("damon_haley_exempt_professional_plan_document.org")
                       :exclude "\\.org$"
                       :table-of-contents nil
                       :section-numbers nil
                       )
                   ("dkh-resume"
                       :base-directory "~/git/dkh-resume/"
                       :base-extension "org"
                       :publishing-directory "~/git/dkh-resume/exports"
                       :publishing-function org-publish-org-to-pdf
                       :include ("resume.org")
                       :exclude "\\.org$"
                       :table-of-contents nil
