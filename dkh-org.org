...
(setq org-agenda-files (quote (
                                    ...
                                    "~/Documents/Tasks/refile.org"
                                    ;;                                    "~/Documents/Tasks/.org-jira/FIT.org"
                                    "~/Documents/Tasks/.org-jira/AFROTC.org"
                                    "~/Documents/Tasks/.org-jira/CUPRE.org"
                                    "~/Documents/Tasks/.org-jira/CS.org"
                                    "~/Documents/Tasks/.org-jira/FAC.org"
                                    "~/Documents/Tasks/.org-jira/VCR.org"
                                    "~/Documents/Tasks/.org-jira/SUP.org"
                                    "~/Documents/Tasks/.org-jira/SHAKE.org"
                                    ))))
#+end_src
...
(add-to-list 'org-agenda-custom-commands
             ...
             ("b" "Agenda"
               ...
               ("~/Documents/agendas/agenda.pdf"))
             ("t" "Agenda" sacha/org-agenda-with-tip))
...
(setq org-agenda-diary-file "~/Documents/Tasks/diary.org")
#+end_src
...
creates date entries in the =~/Documents/Tasks/diary.org= file.
...
;; org-publish-timestamp-directory "~/Documents/Tasks/.org-timestamps/"
;; org-publish-write-cache-file "~/Documents/Tasks/.org-timestamps/inherit-org-info-js.cache"
...
(shell-command (format "open \"`mdfind com_microsoft_outlook_recordID==%s`\""
msgid)))
...
(sacha/random-keybinding)
(sacha/org-agenda-with-tip)

#+end_src

I mainly use org-mode for a collection of TODO-lists.So I get a little annoyed when the [17/23] cookies at the parent level aren't
updated when I remove an item.
